            ...
            <div /* Este es el div 1 */ className="button1">
              <div class="seccion-course">
                <div className="curso1">
                  ...
                  <div className="tit-estrella">
                    <center>Asesoria Personal</center>
                  </div>
                  <div class="des-estrella">
                    Impartido por Nombre Instructor
                  </div>
                </div>
          ...
          {this.state.checked === true && (
            <div /* Este es el div 2 */ className="red2">
              ...
              <div className="tarea1">
                ...
                <div className="textdocument">Modulo 1 Audio</div>
              ...
              <div className="tarea2">
                <FontAwesomeIcon
                  icon={faFile}
                  onClick="#"
                  className="icon-document2"
                ></FontAwesomeIcon>
                <div className="textdocument">Modulo 2 Audio</div>
                <h5 className="description">Loremp ipsun Loremp ipsun</h5>
                <FontAwesomeIcon
                  icon={faArrowAltCircleDown}
                  onClick="#"
